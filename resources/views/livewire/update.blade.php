<form class="row g-3 bg-dark">
    ...
    <div class="col-6">
        ...
        <h1 class="text-white my-3"> Update your address</h1>
        <div class="col-md-6">
        ...
        <div class="col-12">
            <button wire:click.prevent="update()" class="btn btn-primary m-3">Update</button>
            <button wire:click.prevent="cancel()" class="btn btn-danger m-3">Close</button>
        </div>
    </div>
</form>
